...
📍 Malmö, Sweden | ✉️ [psiloc@gmail.com](mailto:psiloc@gmail.com) | 🌐 [github.com/psilore](https://github.com/psilore) | 👻 [shadowfish.night-tower.net (blog)](https://shadowfish.night-tower.net/)
...
#### **Current Assignment: Modelon** _Lund, Sweden (Remote / Hybrid) | 2026 – Present_
...
- **Backend Development:** Linux development in Ubuntu and Debian.

#### **Assignment: Örestad Linux | OpenLogger** _Malmö, Sweden (On site)_

_2020 – 2022_

- **Linux System Administrator:** Administrated and maintained Linux systems for various clients.
- **Unifi Network Administrator:** Administrated and maintained Unifi networks for various clients.
...
- **Frontend Developer:** Developed and launched AI-driven support chatbots for the retail industry, integrating with enterprise backend systems.
